...
class FormularioRegistroUsuarios(UserCreationForm):
    email = forms.EmailField(label="Correo Electronico Registro", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Un correo que revise regularmente'}))
